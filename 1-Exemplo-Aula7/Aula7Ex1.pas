...
begin
   lbNomes.Items.Add( edtNome.Text ); //Defult = Foco no componente = só pode ser usado uma vez
...
begin
   lbNomes.Items.Delete(0); //Deleta a posição que eu coloco aqui
...
begin
   if lbNomes.ItemIndex=-1 then  //caso não tenha escolhido um para deletar
...
begin
   lbNomes.Sorted:=True; //Ordem alfábetica
...
//BitButton = Kind = algumas animações
var
  ultimo: integer;
